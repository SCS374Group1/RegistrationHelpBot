    ...
    var body: some View {
        NavigationView {
            Form {
                ...
                // Creates a button that users can click on to find
                // out how to configure text to speech for their needs
                Section(header: Text("Accessibility")) {
                    Button("Text To Speech"){
                        showingAlert = true
                    }
                    .alert("In order to access Text to Speech, do the following on your iPhone: Settings > Accessibility > Spoken Content. This will allow you to configure the settings for your needs!", isPresented: $showingAlert) {
                                Button("Okay, Sounds Good!") { }
                            }
                }
                // creates a toggle for users to switch between light and dark mode depending on their preference
